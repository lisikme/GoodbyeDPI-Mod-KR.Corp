...
echo [0m------------------------------------- [90m[[96mv2.7.37 [90m- [94m09.14.2024 14:47[90m]
...
powershell Remove-Item C:\goodbyedpi\*.cmd' -Force
powershell Move-Item C:\Windows\Temp\GoodbyeDPI-Mod-KR.Corp-main\*.cmd' -Destination 'C:\goodbyedpi\*.cmd' -Force
