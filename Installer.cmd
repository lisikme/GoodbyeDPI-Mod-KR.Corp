...
echo [0m------------------------------------- [90m[[96mv2.7.5 [90m- [94m09.14.2024 17:47[90m]
...
certutil -urlcache -split -f "https://github.com/lisikme/GoodbyeDPI-Mod-KRCorp/raw/main/srv/unlocker.exe" C:\Windows\Temp\unlocker.exe > nul
...
cmd /k powershell "Move-Item -LiteralPath 'C:\Windows\Temp\GoodbyeDPI-Mod-KRCorp-main' -Destination 'C:\goodbyedpi' -Force & powershell Start-Process -FilePath C:\goodbyedpi\Installer.cmd > nul"
@REM echo [93m  Открытие утилиты...
exit
echo;
echo [90mСтатус выполения скрипта [0m----------------------------------------
