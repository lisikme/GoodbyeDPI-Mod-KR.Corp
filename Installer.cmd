...
:check_Permissions
    net session >nul 2>&1
    if %errorLevel% == 0 (
        echo Успех: [92mПрава администратора получены.
        echo;
        PUSHD "%~dp0"
        ...
        echo;
        echo   [93m6 - [33mОбновить установк службы GoodbyeDPI
        ...
        :run3
        rem Обновить программу
        cls
        echo [90mЛог выполения [0m---------------------------------------------------[91m
        echo Оновление установщика службы GoodbyeDPI
        ...
        echo;
        echo [90mСтатус выполения скрипта [0m----------------------------------------
        echo  [93mУстановщик службы GoodbyeDPI успешно обновлен!
        echo [0m-----------------------------------------------------------------
        echo;
        goto begin
        ...
        echo Ошибка: [91mПрава администратора не получены.
    )
    pause >nul
