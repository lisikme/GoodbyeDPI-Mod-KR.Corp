...
sc description "GoodbyeDPI" "Служба утилиты GoodbyeDPI для обхода пассивного и активного DPI провайдеров и обхода блокировок интернет сайтов. - Univesal"
...
sc description "GoodbyeDPI" "Служба утилиты GoodbyeDPI для обхода пассивного и активного DPI провайдеров и обхода блокировок интернет сайтов. - Modify by KetaruCorp"
start /min sc start "GoodbyeDPI"
sc query "GoodbyeDPI"
POPD
echo;
